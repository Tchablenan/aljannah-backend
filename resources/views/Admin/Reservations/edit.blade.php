...
@section('content')
<!--begin::Form-->
<form id="kt_reservation_form" class="form d-flex flex-column flex-lg-row" action="{{ route('reservations.update', $reservation) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body text-center pt-0">
                <!--begin::Status badge-->
                <div class="mb-5">
                    <span class="badge badge-lg badge-light-{{ $reservation->status == 'confirmed' ? 'success' : ($reservation->status == 'cancelled' ? 'danger' : ($reservation->status == 'completed' ? 'info' : 'warning')) }}">
                ...
                <div class="mb-5">
                    ...
                    <select name="status" class="form-select" data-control="select2" data-placeholder="Sélectionner un statut">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
                ...
                <select name="jet_id" class="form-select" data-control="select2" data-placeholder="Sélectionner un jet">
                    ...
                    @foreach($jets as $jet)
                        <option value="{{ $jet->id }}" 
                                data-capacity="{{ $jet->capacite }}"
                                data-price="{{ $jet->prix ?? 0 }}"
                                {{ $reservation->jet_id == $jet->id ? 'selected' : '' }}>
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="first_name" class="form-control mb-2" placeholder="Prénom du passager" value="{{ old('first_name', $reservation->first_name) }}" required />
                        @error('first_name')
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="last_name" class="form-control mb-2" placeholder="Nom du passager" value="{{ old('last_name', $reservation->last_name) }}" required />
                        @error('last_name')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="email" name="email" class="form-control mb-2" placeholder="Email du passager" value="{{ old('email', $reservation->email) }}" required />
                        @error('email')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="tel" name="phone" class="form-control mb-2" placeholder="Numéro de téléphone" value="{{ old('phone', $reservation->phone) }}" />
                        @error('phone')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-6 fv-row">
                    ...
                    <input type="number" name="passengers" class="form-control mb-2" placeholder="Nombre de passagers" value="{{ old('passengers', $reservation->passengers) }}" min="1" max="20" required />
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="departure_location" class="form-control mb-2" placeholder="Ville ou aéroport de départ" value="{{ old('departure_location', $reservation->departure_location) }}" required />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="arrival_location" class="form-control mb-2" placeholder="Ville ou aéroport d'arrivée" value="{{ old('arrival_location', $reservation->arrival_location) }}" required />
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="datetime-local" name="departure_date" class="form-control mb-2" value="{{ old('departure_date', $reservation->departure_date ? \Carbon\Carbon::parse($reservation->departure_date)->format('Y-m-d\TH:i') : '') }}" required />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="datetime-local" name="arrival_date" class="form-control mb-2" value="{{ old('arrival_date', $reservation->arrival_date ? \Carbon\Carbon::parse($reservation->arrival_date)->format('Y-m-d\TH:i') : '') }}" required />
                        @error('arrival_date')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-6 fv-row">
                    ...
                    <textarea name="message" class="form-control mb-2" rows="4" placeholder="Demandes spéciales, allergies, équipements particuliers...">{{ old('message', $reservation->message ?? '') }}</textarea>
