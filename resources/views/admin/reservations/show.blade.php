...
@section('page-subtitle', 'Réf: ' . ($reservation->reference ?? 'REF-' . str_pad($reservation->id, 6, '0',
STR_PAD_LEFT)))
...
<div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <span class="svg-icon svg-icon-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path
                    ...
                    fill="black" />
                <path
                    d="M20.4615 8.65304L18.3025 10.811L12.5465 5.055L14.7055 2.897C15.0873 2.51528 15.6051 2.30093 16.145 2.30093C16.6849 2.30093 17.2027 2.51528 17.5845 2.897L20.4615 5.774C20.8432 6.15581 21.0576 6.67355 21.0576 7.21345C21.0576 7.75335 20.8432 8.27122 20.4615 8.65304Z"
                    fill="black" />
            </svg>
        </span>
        Modifier
    ...
    <a href="{{ route('reservations.pdf', $reservation) }}" class="btn btn-primary btn-sm" target="_blank">
        <span class="svg-icon svg-icon-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path opacity="0.3"
                    d="M19 22H5C4.4 22 4 21.6 4 21V3C4 2.4 4.4 2 5 2H14L20 8V21C20 21.6 19.6 22 19 22ZM16 13.5L12.5 13V10C12.5 9.4 12.6 9.5 12 9.5C11.4 9.5 11.5 9.4 11.5 10L11 13L8 13.5C7.4 13.5 7.5 13.4 7.5 14C7.5 14.6 7.4 14.5 8 14.5H11V18C11 18.6 11.4 18.5 12 18.5C12.6 18.5 12.5 18.6 12.5 18V14.5H16C16.6 14.5 16.5 14.6 16.5 14C16.5 13.4 16.6 13.5 16 13.5Z"
                    fill="black" />
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        <tbody>
                            <tr>
                                ...
                                <td class="text-gray-900 fw-bolder">{{ $reservation->reference ?? 'REF-' .
                                    str_pad($reservation->id, 6, '0', STR_PAD_LEFT) }}</td>
                            </tr>
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-45px me-5">
                                            <div class="symbol-label bg-light-primary text-primary fs-6 fw-bolder">
                                                ...
                                                substr($reservation->last_name, 0, 1)) }}
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <span class="text-gray-900 fw-bolder fs-6">{{ $reservation->first_name }} {{
                                                $reservation->last_name }}</span>
                                            <a href="mailto:{{ $reservation->email }}"
                                                class="text-muted text-hover-primary fw-bold fs-7">{{
                                                $reservation->email }}</a>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="text-gray-900 fw-bolder me-3">{{ $reservation->departure_location
                                            }}</span>
                                        ...
                                        <span class="text-gray-900 fw-bolder">{{ $reservation->arrival_location
                                            }}</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-gray-900">{{
                                    \Carbon\Carbon::parse($reservation->departure_date)->format('d/m/Y à H:i') }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Date d'arrivée</td>
                                <td class="text-gray-900">{{
                                    \Carbon\Carbon::parse($reservation->arrival_date)->format('d/m/Y à H:i') }}</td>
                            </tr>
                            <tr>
                                    ...
                                    <span class="badge badge-light-primary fs-7">
                                        <span class="svg-icon svg-icon-4 me-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <path
                                                    d="M16 15.6315C16 16.7754 15.3284 17.8236 14.2733 18.3315L13 19.0657V20.5C13 21.0523 12.5523 21.5 12 21.5C11.4477 21.5 11 21.0523 11 20.5V19.0657L9.72671 18.3315C8.67159 17.8236 8 16.7754 8 15.6315V13.5C8 12.3954 8.89543 11.5 10 11.5H14C15.1046 11.5 16 12.3954 16 13.5V15.6315Z"
                                                    fill="black" />
                                                <path opacity="0.3"
                                                    ...
                                                    fill="black" />
                                                <path opacity="0.3"
                                                    d="M7.5 6C8.32843 6 9 5.32843 9 4.5C9 3.67157 8.32843 3 7.5 3C6.67157 3 6 3.67157 6 4.5C6 5.32843 6.67157 6 7.5 6ZM16.5 6C17.3284 6 18 5.32843 18 4.5C18 3.67157 17.3284 3 16.5 3C15.6716 3 15 3.67157 15 4.5C15 5.32843 15.6716 6 16.5 6Z"
                                                    fill="black" />
                                            </svg>
                                        </span>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ $reservation->jet->image_url }}"
                            ...
                            <tr class="bg-light-dark">
                                <td colspan="2" class="fw-bolder text-dark py-2">DOCUMENTS DE VOYAGE & APIS</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Numéro de Passeport</td>
                                <td class="text-gray-900">{{ $reservation->passport_number ?? 'Non renseigné' }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Expiration Passeport</td>
                                <td class="text-gray-900">{{ $reservation->passport_expiry ?
                                    $reservation->passport_expiry->format('d/m/Y') : 'Non renseigné' }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Date de naissance</td>
                                <td class="text-gray-900">{{ $reservation->date_of_birth ?
                                    $reservation->date_of_birth->format('d/m/Y') : 'Non renseigné' }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Nationalité</td>
                                <td class="text-gray-900">{{ $reservation->nationality ?? 'Non renseigné' }}</td>
                            </tr>

                            <tr class="bg-light-dark">
                                <td colspan="2" class="fw-bolder text-dark py-2">BAGAGES</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Nombre de sacs</td>
                                <td class="text-gray-900">{{ $reservation->luggage_count }}</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Poids total</td>
                                <td class="text-gray-900">{{ $reservation->luggage_weight_kg }} kg</td>
                            </tr>

                            <tr class="bg-light-dark">
                                <td colspan="2" class="fw-bolder text-dark py-2">CONSENTEMENT & LÉGAL</td>
                            </tr>
                            <tr>
                                <td class="fw-bolder text-muted">Protection des données</td>
                                <td>
                                    @if($reservation->data_protection_consent)
                                    <span class="badge badge-light-success">Accepté (Act 843)</span>
                                    @else
                                    <span class="badge badge-light-danger">Non accepté</span>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-gray-900">{{ $reservation->status_updated_at->format('d/m/Y à H:i') }}
                                </td>
                            </tr>
                            @endif
                        </tbody>
                        ...
                        <span class="svg-icon svg-icon-3 me-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path opacity="0.3"
                                    ...
                                    fill="black" />
                                <path
                                    d="M21 5H2.99999C2.69999 5 2.49999 5.3 2.59999 5.5L11.4 14.3C11.8 14.7 12.2 14.7 12.6 14.3L21.4 5.5C21.5 5.3 21.3 5 21 5Z"
                                    fill="black" />
                            </svg>
                        </span>
                        Contacter le client
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <div class="text-muted me-2 fs-7">{{ $reservation->created_at->format('d/m/Y à H:i')
                                        }}</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            <div class="pe-3 mb-5">
                                ...
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <div class="text-muted me-2 fs-7">{{ $reservation->status_updated_at->format('d/m/Y
                                        à H:i') }}</div>
                                </div>
                            </div>
                        </div>
