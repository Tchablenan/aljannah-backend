...
<div class="d-flex align-items-center gap-2 gap-lg-3">
    <div class="d-flex align-items-center position-relative my-1">
        ...
        <input type="text" id="searchReservations" class="form-control form-control-solid w-250px ps-14"
            placeholder="Rechercher..." value="{{ request('search') }}" />
    </div>
    <div class="me-4">
        <select class="form-select form-select-solid" id="filterStatus" data-control="select2"
            data-placeholder="Tous statuts">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-reservations-table-filter="search"
                    class="form-control form-control-solid w-250px ps-14" placeholder="Rechercher une réservation"
                    ...
                    <div class="px-7 py-5" data-kt-reservations-table-filter="form">
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                data-placeholder="Sélectionner un statut" data-allow-clear="true"
                                data-kt-reservations-table-filter="status">
                                <option></option>
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid fw-bolder" data-kt-select2="true"
                                data-placeholder="Sélectionner une période" data-allow-clear="true"
                                data-kt-reservations-table-filter="period">
                                <option></option>
                                <option value="today" {{ request('period')=='today' ? 'selected' : '' }}>Aujourd'hui
                                </option>
                                <option value="week" {{ request('period')=='week' ? 'selected' : '' }}>Cette semaine
                                </option>
                                <option value="month" {{ request('period')=='month' ? 'selected' : '' }}>Ce mois
                                </option>
                                <option value="upcoming" {{ request('period')=='upcoming' ? 'selected' : '' }}>À venir
                                </option>
                            </select>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="reset" class="btn btn-light btn-active-light-primary fw-bold me-2 px-6"
                                ...
                                data-kt-reservations-table-filter="reset">Réinitialiser</button>
                            <button type="submit" class="btn btn-primary fw-bold px-6" data-kt-menu-dismiss="true"
                                data-kt-reservations-table-filter="filter">Appliquer</button>
                        </div>
                        <!--end::Actions-->
                    </div>
                    <!--end::Content-->
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_reservations_table">
            ...
            <thead>
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    <th class="w-10px pe-2">
                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                data-kt-check-target="#kt_reservations_table .form-check-input" value="1" />
                        </div>
                    </th>
                    ...
                    <th class="min-w-80px">Bagages</th>
            ...
            <tbody class="text-gray-600 fw-bold">
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <div class="symbol-label bg-light-primary">
                                <span class="text-primary fw-bolder fs-4">{{ strtoupper(substr($reservation->first_name,
                                    0, 1) . substr($reservation->last_name, 0, 1)) }}</span>
                            </div>
                        </div>
                        <!--end::Avatar-->
                        ...
                        <div class="d-flex flex-column">
                            <a href="{{ route('reservations.show', $reservation) }}"
                                class="text-gray-800 text-hover-primary mb-1 fw-bolder">{{ $reservation->full_name
                                }}</a>
                            <span class="text-muted">{{ $reservation->reference }}</span>
                        </div>
                        <!--end::Client details-->
                    </td>
                    <!--end::Client-->
                    ...
                    <td>
                        <div class="d-flex flex-column">
                            <a href="mailto:{{ $reservation->email }}" class="text-gray-800 text-hover-primary mb-1">{{
                                $reservation->email }}</a>
                    ...
                    <td>
                        <div class="d-flex flex-column">
                            <span class="text-gray-800 fw-bolder mb-1">{{ $reservation->departure_date->format('d/m/Y')
                                }}</span>
                            @if($reservation->arrival_date->format('Y-m-d') !==
                    ...
                    <td>
                        <div class="d-flex flex-column">
                            <span class="text-gray-800 fw-bolder mb-1">{{ $reservation->luggage_count }} sacs</span>
                            <span class="text-muted">{{ $reservation->luggage_weight_kg }} kg</span>
                        </div>
                    </td>
                    <!--end::Luggage-->
                    ...
                    <td>
                        <div class="d-flex flex-column">
                            <span class="text-gray-800 fw-bolder mb-1">${{
                                number_format($reservation->total_amount_with_taxes, 2) }}</span>
                            <span class="text-muted fs-8">Taxes incl.</span>
                        </div>
                    </td>
                    <!--end::Total-->
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="{{ route('reservations.pdf', $reservation) }}" class="menu-link px-3"
                                    target="_blank">
                                    <span class="svg-icon svg-icon-3 me-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                ...
                <tr>
                    <td colspan="9" class="text-center py-10">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('reservations.create') }}" class="btn btn-primary">Nouvelle
                                Réservation</a>
                        </div>
                    </td>
                </tr>
