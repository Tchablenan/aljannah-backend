...
@section('content')
<!--begin::Form-->
<form id="kt_reservation_form" class="form d-flex flex-column flex-lg-row" action="{{ route('reservations.store') }}" method="POST">
    @csrf
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="first_name" class="form-control mb-2" placeholder="Prénom du passager" value="{{ old('first_name') }}" required />
                        @error('first_name')
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="last_name" class="form-control mb-2" placeholder="Nom du passager" value="{{ old('last_name') }}" required />
                        @error('last_name')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="email" name="email" class="form-control mb-2" placeholder="Email du passager" value="{{ old('email') }}" required />
                        @error('email')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="tel" name="phone" class="form-control mb-2" placeholder="Numéro de téléphone" value="{{ old('phone') }}" />
                        @error('phone')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-6 fv-row">
                    ...
                    <input type="number" name="passengers" class="form-control mb-2" placeholder="Nombre de passagers" value="{{ old('passengers', 1) }}" min="1" max="20" required />
            ...
            <div class="card-body pt-0">
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="departure_location" class="form-control mb-2" placeholder="Ville ou aéroport de départ" value="{{ old('departure_location') }}" required />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" name="arrival_location" class="form-control mb-2" placeholder="Ville ou aéroport d'arrivée" value="{{ old('arrival_location') }}" required />
                ...
                <div class="row mb-6">
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="datetime-local" name="departure_date" class="form-control mb-2" value="{{ old('departure_date') }}" required />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="datetime-local" name="arrival_date" class="form-control mb-2" value="{{ old('arrival_date') }}" required />
                        @error('arrival_date')
                            <div class="text-danger fs-7">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-6 fv-row">
                    ...
                    <textarea name="message" class="form-control mb-2" rows="4" placeholder="Demandes spéciales, allergies, équipements particuliers...">{{ old('message') }}</textarea>
